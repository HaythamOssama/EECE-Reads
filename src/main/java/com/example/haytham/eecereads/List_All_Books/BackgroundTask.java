 ...
 *  = This class invokes a loading dialog.
...
public class BackgroundTask extends AsyncTask<String,Void,String> {
    ...
    BackgroundTask(Activity context,FoundFragment foundFragment){
        this.context=context;
        this.foundFragment =foundFragment;
    }

    BackgroundTask(Activity context, BorrowedFragment borrowedFragment){
        this.context=context;
        this.borrowedFragment =borrowedFragment;
    }
    BackgroundTask(Activity context, RequestedFragment requestedFragment){
        this.context=context;
