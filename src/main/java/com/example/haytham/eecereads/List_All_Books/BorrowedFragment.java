...
public class BorrowedFragment extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public static List<Books> borrowedList = new ArrayList<>(); // List of borrowed books
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView;
        rootView =  inflater.inflate(R.layout.fragment_borrowed, container, false);
        recyclerView  = (RecyclerView) rootView.findViewById(R.id.recycler_view2);
        nobooks_image = (ImageView)    rootView.findViewById(R.id.nobooks2);

        // Pull to refresh view
        final PullToRefreshView mPullToRefreshView = (PullToRefreshView) rootView.findViewById(R.id.pull_to_refresh2);
                ...
                mPullToRefreshView.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(isNetworkAvailable()) {
                            // Clear the borrowedlist to avoid any duplicates
                            borrowedList.clear();
                            try {
                                // Execute a background task that fetches the borrowed books from the server
                                //  OnPostExecute calls fillWithData function
                                BackgroundTask backgroundTask = new BackgroundTask(getActivity(), BorrowedFragment.this);
                                backgroundTask.execute("fetch_borrowed");
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
        ...
        if(borrowedList.isEmpty()){
            ...
            mAdapter = new BooksAdapter(borrowedList,BorrowedFragment.this);
    ...
    public void fillWithData(String result) {
        ...
        try {
            ...
            while (count < jsonArray.length()) {
                ...
                Books Books = new Books(title, name, type,status,pin); // add a new book
                borrowedList.add(Books);
                count++;
            }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        arrange_alpha.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener(){
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                Collections.sort(borrowedList, rankOrder);
                mAdapter = new BooksAdapter(borrowedList,BorrowedFragment.this);
                recyclerView.setAdapter(mAdapter);
                return true;
            }
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        final List<Books> filteredModelList = filter(borrowedList, newText);
    ...
    public void OpenDialog(String title, String name){
        ...
        DialogAlert dialogFragment = new DialogAlert (getContext(),BorrowedFragment.this,title,name);
